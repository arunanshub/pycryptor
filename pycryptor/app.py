...
class ARCFrame(ttk.Frame):
    ...
    def __init__(
        ...
        *args,
        master,
        listbox: typing.Optional[ListBox] = None,
        **kwargs,
    ):
        super().__init__(*args, master=master, **kwargs)
        if listbox is None:
            raise ValueError("listbox is None")
...
class Waitbox(tk.Toplevel):
    ...
    def __init__(
        self, *args, master, operation, current=0, maximum=100, **kwargs
    ):
        super().__init__(*args, master=master, **kwargs)
        ...
        self._progress_bar.grid(row=1, column=0, sticky="sew")
...
class EncDecFrame(ttk.Frame):
    ...
    def on_configure(self):
        ...
        top.transient(self.master)  # type: ignore
        top.focus_set()
        top.wait_visibility()
        top.grab_set()
    ...
    def _build_waitbox(self, operation):
        ...
        waitbox.transient(self.master)  # type: ignore
        waitbox.focus_set()
